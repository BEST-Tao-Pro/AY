<template>
  <div class="parent">
    ...
    <div class="div8"> <el-input style="width: 100px" v-model.number="value1">   </el-input></div>
    ...
    <div class="div12"><p style="margin: 10px">   <el-input v-model.number="value2" style="width: 100px">   </el-input>   </p> </div>
    ...
    <div class="div16"><p>   <el-input v-model.number="value3" style="width: 100px">   </el-input>   </p> </div>
    ...
    <div class="div20"><p style="margin: 10px">   <el-input v-model.number="value4" style="width: 100px"></el-input>   </p> </div>
    ...
    <div class="div24" ><el-input v-model.number="value5" style="margin: 10px"></el-input></div>
    ...
    <div class="div28" ><el-input v-model.number="value6" style="margin: 10px"></el-input></div>
    <el-form-item>
