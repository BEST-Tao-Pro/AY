<template>
  ...
  <div class="parent">
    ...
    <div class="div8"> <el-input style="width: 100px" v-model.number="value1" :disabled="user.data.value.self==1">   </el-input></div>
    ...
    <div class="div12"><p style="margin: 10px">   <el-input style="width: 100px" v-model.number="value2" :disabled="user.data.value.self==1">   </el-input>   </p> </div>
    ...
    <div class="div16"><p>   <el-input style="width: 100px" v-model.number="value3" :disabled="user.data.value.self==1">   </el-input>   </p> </div>
    ...
    <div class="div20"><p style="margin: 10px">   <el-input style="width: 100px" v-model.number="value4" :disabled="user.data.value.self==1"></el-input>   </p> </div>
    ...
    <div class="div24" ><el-input style="margin: 10px" v-model.number="value5" :disabled="user.data.value.self==1"></el-input></div>
    ...
    <div class="div28" ><el-input style="margin: 10px" v-model.number="value6" :disabled="user.data.value.self==1"></el-input></div>
    <el-form-item>
      <el-button type="primary" @click="submitForm"  :disabled="user.data.value.self==1">
        确认
      </el-button>
    </el-form-item>
  </div>
...
let data={
  ...
  grade:(value1.value+value2.value+value3.value+value4.value+value5.value+value6.value)/6,
